...
cp /anvil/projects/x-cis230165/testRuns/Gadget/ics-sizes/ic-s16.0 ICs

EXEC=../../Gadget2
EXECHPAS=/anvil/projects/x-cis230165/tools/HPAS/install/bin/hpas


srun --overlap --ntasks-per-node=32 --cpu-bind=map_cpu:0,4,8,12,16,20,24,28,32,36,40,44,48,52,56,60,64,68,72,76,80,84,88,92,96,100,104,108,112,116,120,124 ${EXECHPAS}  cpuoccupy -u 30 &
